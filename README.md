...
#build image
docker build -t softwarepioniere/eventstore:latest .
...
pushd cluster-node1
docker build -t softwarepioniere/eventstore-node1:latest .
popd
pushd cluster-node2
docker build -t softwarepioniere/eventstore-node2:latest .
popd
pushd cluster-node2
docker build -t softwarepioniere/eventstore-node3:latest .
popd
